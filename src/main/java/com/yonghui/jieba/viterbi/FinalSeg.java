package com.yonghui.jieba.viterbi;

import com.yonghui.jieba.CharacterUtil;
import com.yonghui.jieba.Node;
import com.yonghui.jieba.Pair;
    ...
    private void loadModel() {
        ...
        try {
            ...
            try {
                ...
                log.error(String.format(Locale.getDefault(), "%s: close failure!", PROB_EMIT), e);
            }
        }
